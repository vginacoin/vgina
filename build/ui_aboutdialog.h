...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About VGINA", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>VGINA</b> version", 0));
...
"Copyright \302\251 2014 The VGINA developers", 0));
