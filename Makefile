#############################################################################
# Makefile for building: vgina-purse
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DQT_STATIC -DQT_DISABLE_DEPRECATED_BEFORE=0x040800 -DUSE_UPNP=1 -DSTATICLIB -DUSE_DBUS -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_DBUS_LIB -DQT_NETWORK_LIB -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -m64 -pipe -O2 -D_REENTRANT -Wall -W -fPIE $(DEFINES)
CXXFLAGS      = -fpermissive -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2 -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector -fPIE $(DEFINES)
...
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lminiupnpc /home/jimmy/Desktop/newvgina/vgina/src/leveldb/libleveldb.a /home/jimmy/Desktop/newvgina/vgina/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5DBus -lQt5Network -lQt5Gui -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/jimmy/Desktop/newvgina/vgina/src/leveldb/libleveldb.a /home/jimmy/Desktop/newvgina/vgina/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
...
/home/jimmy/Desktop/newvgina/vgina/src/leveldb/libleveldb.a: FORCE
	cd /home/jimmy/Desktop/newvgina/vgina/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/jimmy/Desktop/newvgina/vgina/build/build.h: FORCE
	cd /home/jimmy/Desktop/newvgina/vgina; /bin/sh share/genbuild.sh /home/jimmy/Desktop/newvgina/vgina/build/build.h
